...
export const Footer: React.FC = () => {
  ...
  const footerLinks = {
    product: [
      ...
      { label: 'API Reference', href: 'https://kalori-makanan-kkm.onrender.com/docs', external: true },
      { label: 'Examples', href: '#examples' },
    ],
    developers: [
      { label: 'Getting Started', href: '#docs' },
      { label: 'API Status', href: 'https://kalori-makanan-kkm.onrender.com/health', external: true },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4 max-w-sm">
              Fast & reliable food calorie API with 750+ Malaysian & International foods.
              Perfect for nutrition apps and health platforms.
            </p>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-center md:text-left">
              <p className="text-gray-600 dark:text-gray-400 text-sm">
                © {currentYear} Kalori Makanan API. All rights reserved.
              </p>
            </div>
